...
def main(_):
    ...
    # mmnist = load_mmnist(cfg.mc_dataset)
    mmnist = load_submmnist(cfg.mc_dataset)

    num_batches = int(600000 / cfg.mc_batch_size) * cfg.mc_num_epochs
    ...
    batch_trainX, batch_trainY = tf.train.shuffle_batch(training_queue,
                                                        num_threads=cfg.mc_num_threads,
                                                        batch_size=cfg.mc_batch_size,
                                                        capacity=cfg.mc_batch_size * 64,
                                                        min_after_dequeue=cfg.mc_batch_size * 32,
    ...
    test_queue = tf.train.slice_input_producer([tf.convert_to_tensor(mmnist["te0X"], tf.float32),
                                                tf.convert_to_tensor(mmnist["te0Y"], tf.int32),
                                                tf.convert_to_tensor(mmnist["te2X"], tf.float32),
                                                tf.convert_to_tensor(mmnist["te2Y"], tf.int32),
                                                tf.convert_to_tensor(mmnist["te4X"], tf.float32),
                                                tf.convert_to_tensor(mmnist["te4Y"], tf.int32),
                                                tf.convert_to_tensor(mmnist["te6X"], tf.float32),
                                                tf.convert_to_tensor(mmnist["te6Y"], tf.int32),
                                                tf.convert_to_tensor(mmnist["te8X"], tf.float32),
                                                tf.convert_to_tensor(mmnist["te8Y"], tf.int32)])
    ...
    for batch_num in range(num_batches):
        ...
        print(
            ...
            _tr_clsacc)
        print("\texps:", "%.3f" % (cfg.mc_batch_size / (time.time() - start)))
