...
class CapsNet:
    ...
    def __init__(self, b_size=cfg.mc_batch_size):
    ...
    def _margin_loss(self, digitcaps, Y, m_plus=cfg.mc_m_plus, m_minus=cfg.mc_m_minus, lambda_val=cfg.mc_lambda_val):
        # The margin loss
        # [batch_size, 10, 1, 1]
    ...
    def _acc(self, digitcaps, Y):
        ...
        assert softmax_v.get_shape() == [cfg.mc_batch_size, 10, 1, 1]
    ...
    def comp_output(self, X, Y, keep_prob, reg_scale=cfg.mc_regularization_scale):
